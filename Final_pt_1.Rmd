...
cTab3 <- table(train$payment_status, predLoan) 
...
cTab4 <- table(train$payment_status, predLoan) 
...
cTab35 <- table(train$payment_status, predLoan) 
...
cTab6 <- table(train$payment_status, predLoan) 
...
```
It appears the lower the threshhold, the more loans are predicted as 'Good'.  Overall accuracy is pretty consistent from a threshhold of .3 to .6. However, as threshhold decreases, "Good loan"
